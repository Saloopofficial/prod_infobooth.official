            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center text-white">
                        <h1 class="" style="font-family: 'Cutive Mono'; font-size: 77px;">Contact US</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        ...
                        <h2 class="para-desc mx-auto mb-1">Customer satisfaction is our top priority</h2>
                        <h4 class="text-muted para-desc mx-auto mb-1">Don't hesitate to contact us</h4>
                    </div>
                </div>
            </div>
            <div class="row">
            <div class="col-md-1 mt-6 pt-2">
            </div>
                <div class="col-md-5 mt-6 pt-2">
                    <div class="how-it-work-box bg-light p-4 text-center rounded shadow">
                        ...
                        <div>
                            ...
                            <p class="text-muted">+91 8750510042</p>
                ...
                <div class="col-md-5 mt-6 pt-2">
                    <div class="how-it-work-box bg-light p-4 text-center rounded shadow">
                        ...
                        <div>
                            <h5>Email Id :</h5>
                            <p class="text-muted"> Contactus@infobooth.in</p>
